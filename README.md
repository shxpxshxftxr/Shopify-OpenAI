# Haiku AI
A simple SPA to submit themes to the OpenAI API (https://beta.openai.com/overview) to receive a special Haiku from the curie AI model. Built for the Shopify Internship Challenge 2022.
